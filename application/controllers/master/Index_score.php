...
class Index_score extends Base_controller {
    ...
    public function index() {
        $data = array_merge($this->global, [
            ...
            'css' => [
                ...
                '../vendors/spectrum-colorpicker/spectrum.css'
            ],
            'js' => [
                '../vendors/metronic-admin/dist/assets/plugins/custom/datatables/datatables.bundle.js',
                '../vendors/spectrum-colorpicker/spectrum.js',
                'admin/master/index-score/list.js',
                'admin/master/index-score/add-edit.js'
            ],
        ]);
        $this->template->load('admin/layout', 'admin/master/index_score/index', $data);
    }
