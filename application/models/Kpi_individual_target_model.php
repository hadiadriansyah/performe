...
class Kpi_individual_target_model extends CI_Model {
    protected $table = 'npm_kpi_individual_target';
    
    public function exists(array $data) {
        $this->db->from($this->table)
                    ->where('kpi_individual_id', $data['kpi_individual_id']);
    ...
    public function delete_by_kpi_individual_id($id) {
        return $this->db->delete($this->table, ['kpi_individual_id' => $id]);
    }
    ...
    public function get_by_kpi_individual_id($id) {
        $this->db->from($this->table)
                 ->where("{$this->table}.kpi_individual_id", $id);
        return $this->db->get()->row_array();
    }
}