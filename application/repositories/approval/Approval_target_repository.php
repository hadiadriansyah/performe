...
require_once(APPPATH . 'interface/approval/Approval_target_repository_interface.php');

#[\AllowDynamicProperties]
class Approval_target_repository implements Approval_target_repository_interface {
    protected $approval_model;
    protected $approval_target_model;
    protected $emp_data_peg_model;
    protected $hist_approval_target_model;
    ...
    protected $kpi_individual_target_model;
    ...
    public function __construct() {
        ...
        $CI->load->model('Approval_target_model');
        $this->approval_target_model = $CI->Approval_target_model;
        $CI->load->model('Emp_data_peg_model');
        $this->emp_data_peg_model = $CI->Emp_data_peg_model;
        $CI->load->model('Hist_approval_target_model');
        $this->hist_approval_target_model = $CI->Hist_approval_target_model;
        ...
        $CI->load->model('Kpi_individual_target_model');
        $this->kpi_individual_target_model = $CI->Kpi_individual_target_model;
    ...
    public function exists_submit_target($data) {
        return $this->approval_target_model->exists($data);
    }

    public function get_approval_employees($year_period_id, $unit_id, $position_id) {
        return $this->approval_target_model->get_approval_employees($year_period_id, $unit_id, $position_id);
    }

    public function get_approval_target_by_pa_individual_id($pa_individual_id, $month_period) {
        return $this->approval_target_model->get_by_pa_individual_id($pa_individual_id, $month_period);
    }
    
    public function update_submit_target($data) {
        return $this->approval_target_model->update($data);
    }
    ...
    public function get_hist_approval_target($approval_target_id) {
        return $this->hist_approval_target_model->get_by_approval_target_id($approval_target_id);
    }
    
    public function store_hist_approval_target($data) {
        return $this->hist_approval_target_model->store($data);
    }
    ...
    public function get_kpi_individual_target_by_pa_individual_id_year_period_id($data) {
        return $this->kpi_individual_model->get_kpi_individual_target_by_pa_individual_id_year_period_id($data);
    }
    ...
    public function submit_kpi($data) {
        return $this->kpi_individual_model->submit_kpi_target($data);
    }
    ...
    public function get_target_by_id($id) {
        return $this->kpi_individual_target_model->get_by_id($id);
    }

    public function store_target($data) {
        return $this->kpi_individual_target_model->store($data);
    }

    public function update_target($data) {
        return $this->kpi_individual_target_model->update($data);
    }
