...
require_once(APPPATH . 'interface/performance_appraisal/Individual_performance_appraisal_repository_interface.php');

#[\AllowDynamicProperties]
class Individual_performance_appraisal_repository implements Individual_performance_appraisal_repository_interface {
    ...
    public function store_submit_pa($data) {
        return $this->approval_pa_model->store($data);
    }
    ...
    public function store_actual($data) {
        return $this->kpi_individual_actual_model->store($data);
    }

    public function update_actual($data) {
