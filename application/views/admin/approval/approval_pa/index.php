    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Approval Performance Appraisal</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">Approval Performance Appraisal</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card">
                ...
                <div class="card-body">
                            ...
                            <div class="card card-xxl-stretch">
                                ...
                                <div class="card-header card-header bg-gradient-info">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label fw-bolder text-white">Approval Performance Appraisal</span>
                                    </h3>
                                </div>
                                <!--end::Card header-->
                                <!--begin::Card body-->
                                <div class="card-body">
                                    <!--begin::Form-->
                                    <form id="kt_approval_pa_form" class="form" action="#">
                                        <!--begin::Row-->
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex flex-wrap flex-stack">
                                        <div>
                                            ...
                                            <div class="fv-row mb-7">
                                                <!--begin::Label-->
                                                <label class="required fw-bold fs-6 mb-2">Month Period</label>
                                                <!--end::Label-->
                                                <div class="d-flex align-items-center">
                                                    <!--begin::Input-->
                                                    <select name="from_month" aria-label="Select first month" data-control="select2" data-placeholder="Select first month..." class="form-select form-select-solid fw-bolder me-2" data-allow-clear="true">
                                                        <option></option>
                                                    ...
                                                    <!--begin::Input-->
                                                    <select name="to_month" aria-label="Select last month" data-control="select2" data-placeholder="Select last month..." class="form-select form-select-solid fw-bolder" data-allow-clear="true">
                                                        <option></option>
                                                        <option value="1">January</option>
                                                        <option value="2">February</option>
                                                        <option value="3">March</option>
                                        ...
                                        <div class="d-flex flex-wrap">
                                            ...
                                            <!--end::Percentage-->
                                            <!--begin::Score-->
                                            <div class="border border-info border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3" id="kt_kpi_score_container">
                                                <!--begin::Number-->
                                                <div class="d-flex align-items-center">
                                                    <div class="fs-2hx fw-bolder" id="kt_kpi_score" data-kt-countup="true" data-kt-countup-value="0.00"data-kt-countup-decimal-places="2">0.00</div>
                                                </div>
                                                <!--end::Number-->
                                                <input type="hidden" name="score" id="kt_kpi_score_input" value="0">
                                                <!--begin::Label-->
                                                <div class="fw-bold fs-6 text-gray-400">Score</div>
                                                <!--end::Label-->
                                            </div>
                                            <!--end::Score-->
                                        </div>
                                        ...
                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_kpis">
                                            ...
                                            <thead>
                                                ...
                                                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                                    ...
                                                    <th class="min-w-50px">Measurement</th>
                                                    <th class="min-w-50px">Target</th>
                                                    <th class="min-w-50px">Actual</th>
                                                    <th class="min-w-50px">Counter</th>
                                                    <th class="min-w-50px">Polarization</th>
                    ...
                    <!--end::Row-->
                    <!--begin::Row-->
                    <div class="row d-none" id="kt_pa_submit_container">
                        <div class="col-12">
                            <!--begin::KPI-->
                            <div class="card card-xxl-stretch">
                                <!--begin::Card header-->
                                <div class="card-header card-header bg-gradient-primary">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label fw-bolder text-white">Performance Appraisal Submit Information</span>
                                    </h3>
                                </div>
                                <!--end::Card header-->
                                <!--begin::Card body-->
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_target_submit">
                                            ...
                                            <tbody class="fw-bold text-gray-600">
                                                ...
                                                <tbody id="kt_table_pa_submit_approval"></tbody>
                                            </tbody>
                                    ...
                                    <div class="modal fade" id="kt_modal_submit_pa" tabindex="-1" aria-hidden="true">
                                        <!--begin::Modal dialog-->
                                        <div class="modal-dialog modal-dialog-centered mw-650px">
                                            <!--begin::Modal content-->
                                            <div class="modal-content">
                                                <!--begin::Modal header-->
                                                <div class="modal-header" id="kt_modal_submit_pa_header">
                                                    <!--begin::Modal title-->
                                                    <h2 class="fw-bolder" id="kt_modal_submit_pa_header_title">Submit Performance Appraisal</h2>
                                                    <!--end::Modal title-->
                                                    <!--begin::Close-->
                                                    <div class="btn btn-icon btn-sm btn-active-icon-primary" data-kt-submit-pa-modal-action="close">
                                                        <!--begin::Svg Icon | path: icons/duotune/arrows/arr061.svg-->
                                                        <span class="svg-icon svg-icon-1">
                                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                                <rect opacity="0.5" x="6" y="17.3137" width="16" height="2" rx="1" transform="rotate(-45 6 17.3137)" fill="black" />
                                                ...
                                                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                                    <!--begin::Form-->
                                                    <form id="kt_modal_submit_pa_form" class="form">
                                                        <!--begin::Scroll-->
                                                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_submit_pa_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_submit_pa_header" data-kt-scroll-wrappers="#kt_modal_submit_pa_scroll" data-kt-scroll-offset="300px">
                                                            <!--begin::Input group-->
                                                            <div class="fv-row mb-7">
                                                                <!--begin::Label-->
                                                        ...
                                                        <!--begin::Actions-->
                                                        <div class="text-center pt-15">
                                                            <button type="reset" class="btn btn-light me-3" data-kt-submit-pa-modal-action="cancel">Discard</button>
                                                            <button type="submit" class="btn btn-primary" data-kt-submit-pa-modal-action="submit">
                                                                <span class="indicator-label">Submit</span>
                                                                <span class="indicator-progress">Please wait...
                                                                <span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                                                            </button>
