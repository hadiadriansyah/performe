    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Individual Performance Appraisal</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">Performance Appraisal</li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
                        <span class="bullet bg-gray-200 w-5px h-2px"></span>
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">Individual Performance Appraisal</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <!--begin::Individual Performance Appraisal-->
                            <div class="card card-xxl-stretch">
                                <!--begin::Card header-->
                                <div class="card-header card-header bg-gradient-info">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label fw-bolder text-white">Individual Performance Appraisal</span>
                                    </h3>
                                </div>
                                <!--end::Card header-->
                                <!--begin::Card body-->
                            ...
                            <!--end::Individual Performance Appraisal-->
                        </div>
                    </div>
                    <!--end::Row-->
                    <!--begin::Row-->
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex flex-wrap flex-stack">
                                        ...
                                        <div class="d-flex flex-wrap">
                                            ...
                                            <!--end::Percentage-->
                                            <!--begin::Score-->
                                            <div class="border border-info border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3 d-none" id="kt_kpi_score_container">
                                                <!--begin::Number-->
                                                <div class="d-flex align-items-center">
                        ...
                        <div class="col-12">
                            ...
                            <div class="card card-xxl-stretch">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_pa_submit">
                                            ...
                                            <tbody class="fw-bold text-gray-600">
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="4">            
                                                        <form id="kt_pa_submit_form" class="form" action="#">
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                ...
                                                                <button type="submit" class="btn btn-primary min-w-125px" data-kt-pa-submit-button-action="submit" disabled>
                                                                    <span class="indicator-label">Submit</span>
                                                                    <span class="indicator-progress">Please wait...
                                                                    <span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                                                                </button>
